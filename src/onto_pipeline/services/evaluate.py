...
def new_session(
    ...
    De dónde salió el par (corpus, ontología) no es asunto de esta capa. La API crea sus
    sesiones con `sessions.create` y le pone el nombre que ella sabe resolver.
    """
    ...
    return sessions.create(workspace.conn, use_case=use_case, name=name)
