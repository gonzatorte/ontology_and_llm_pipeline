...
**Por qué existe.** Hay dos interfaces sobre el mismo pipeline —`cli`, de banderas, y `wizard`,
línea por línea— y el cuerpo de una etapa no puede vivir en ninguna de las dos sin que la otra
lo copie. Antes vivía en `cli.py`: cargar config, llamar al dominio y pintar tablas de `rich`
estaban en la misma función, y eso hacía imposible correr una etapa desde otro lado.
